$(function() {
    ...
    $($(".workicon span")[0]).click(function(){
        $(".work").css("display","block");
        $(".example").css("display","none");
    })
    $($(".workicon span")[1]).click(function(){
        $(".example").css("display","block");
        $(".work").css("display","none");
    })

    $(".workicon span").click(function(){
        $(".workicon span").css({"background":"#1E1E1E","color":"#1d9d74"});
        $(this).css({"background":"#434043","color":"#FFF"})
    })
});
